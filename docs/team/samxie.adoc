...
* Changed Logo
* Added `order` Command
* Added Food Selector which selects food based on Food's ratings and price
* Added Order Manager which phones an order and emails restaurant provider of food
