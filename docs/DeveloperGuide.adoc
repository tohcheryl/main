...
. The program will email the restaurant with a confirmation
. Furthermore, a phone call will be held if applicable
...
.. The server will initiate a phone call via Twillio (or an equivalent service) to the chosen food's phone number.
