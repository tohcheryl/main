...
public class IndexTest {
    ...
    public void equals() {
        ...
        assertTrue(fifthFoodIndex.equals(Index.fromOneBased(5)));
        assertTrue(fifthFoodIndex.equals(Index.fromZeroBased(4)));

        // same object -> returns true
        assertTrue(fifthFoodIndex.equals(fifthFoodIndex));

        // null -> returns false
        assertFalse(fifthFoodIndex.equals(null));

        // different types -> returns false
        assertFalse(fifthFoodIndex.equals(5.0f));
