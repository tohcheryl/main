...
public class ParserUtilTest {
    ...
    private static final String VALID_NAME = "Ranch Sauce";
    private static final String VALID_PHONE = "123456";
    private static final String VALID_ADDRESS = "123 Main Street #0505";
    private static final String VALID_EMAIL = "ranch@example.com";
    private static final String VALID_TAG_1 = "fried";
    private static final String VALID_TAG_2 = "tasty";
