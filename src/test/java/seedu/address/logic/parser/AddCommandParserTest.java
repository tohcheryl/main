...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Food expectedFood = new FoodBuilder().withName(VALID_NAME_BANANA).withPhone(VALID_PHONE_BANANA)
                ...
                .withPrice(VALID_PRICE_BANANA).withTags(VALID_TAG_FRIED).build();

        // whitespace only preamble
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BANANA + PHONE_DESC_BANANA + EMAIL_DESC_BANANA
                + ADDRESS_DESC_BANANA + PRICE_DESC_BANANA + TAG_DESC_FRIED, new AddCommand(expectedFood));
        ...
        assertParseSuccess(parser, NAME_DESC_BANANA + PHONE_DESC_BANANA + EMAIL_DESC_BANANA + ADDRESS_DESC_BANANA
                + PRICE_DESC_BANANA + TAG_DESC_NUTS + TAG_DESC_FRIED, new AddCommand(expectedFoodMultipleTags));
    }
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, INVALID_NAME_DESC + PHONE_DESC_BANANA + EMAIL_DESC_BANANA + ADDRESS_DESC_BANANA
                + PRICE_DESC_BANANA + TAG_DESC_NUTS + TAG_DESC_FRIED, Name.MESSAGE_NAME_CONSTRAINTS);

        // invalid phone
        assertParseFailure(parser, NAME_DESC_BANANA + INVALID_PHONE_DESC + EMAIL_DESC_BANANA + ADDRESS_DESC_BANANA
                + PRICE_DESC_BANANA + TAG_DESC_NUTS + TAG_DESC_FRIED, Phone.MESSAGE_PHONE_CONSTRAINTS);

        // invalid email
        assertParseFailure(parser, NAME_DESC_BANANA + PHONE_DESC_BANANA + INVALID_EMAIL_DESC + ADDRESS_DESC_BANANA
                + PRICE_DESC_BANANA + TAG_DESC_NUTS + TAG_DESC_FRIED, Email.MESSAGE_EMAIL_CONSTRAINTS);

        // invalid address
        assertParseFailure(parser, NAME_DESC_BANANA + PHONE_DESC_BANANA + EMAIL_DESC_BANANA + INVALID_ADDRESS_DESC
                + PRICE_DESC_BANANA + TAG_DESC_NUTS + TAG_DESC_FRIED, Address.MESSAGE_ADDRESS_CONSTRAINTS);

        // invalid price
        assertParseFailure(parser, NAME_DESC_BANANA + PHONE_DESC_BANANA + EMAIL_DESC_BANANA + INVALID_ADDRESS_DESC
                + INVALID_PRICE_DESC + TAG_DESC_NUTS + TAG_DESC_FRIED, Address.MESSAGE_ADDRESS_CONSTRAINTS);

        // invalid tag
        assertParseFailure(parser, NAME_DESC_BANANA + PHONE_DESC_BANANA + EMAIL_DESC_BANANA + ADDRESS_DESC_BANANA
                + PRICE_DESC_BANANA + INVALID_TAG_DESC + VALID_TAG_FRIED, Tag.MESSAGE_TAG_CONSTRAINTS);

        // two invalid values, only first invalid value reported
        assertParseFailure(parser, INVALID_NAME_DESC + PHONE_DESC_BANANA + EMAIL_DESC_BANANA
                        + INVALID_ADDRESS_DESC + PRICE_DESC_BANANA, Name.MESSAGE_NAME_CONSTRAINTS);

        // non-empty preamble
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + NAME_DESC_BANANA + PHONE_DESC_BANANA + EMAIL_DESC_BANANA
                + ADDRESS_DESC_BANANA + PRICE_DESC_BANANA + TAG_DESC_NUTS + TAG_DESC_FRIED,
