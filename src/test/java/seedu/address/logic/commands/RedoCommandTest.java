...
public class RedoCommandTest {
    ...
    private final DeleteCommand deleteCommandOne = new DeleteCommand(INDEX_FIRST_FOOD);
    private final DeleteCommand deleteCommandTwo = new DeleteCommand(INDEX_SECOND_FOOD);
