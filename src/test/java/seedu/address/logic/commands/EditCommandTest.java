...
public class EditCommandTest {
    ...
    public void execute_allFieldsSpecifiedUnfilteredList_success() throws Exception {
        Food editedFood = new PersonBuilder().build();
        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder(editedFood).build();
        ...
        expectedModel.updatePerson(model.getFilteredPersonList().get(0), editedFood);
    ...
    public void execute_someFieldsSpecifiedUnfilteredList_success() throws Exception {
        ...
        Food lastFood = model.getFilteredPersonList().get(indexLastPerson.getZeroBased());

        PersonBuilder personInList = new PersonBuilder(lastFood);
        ...
        Model expectedModel = new ModelManager(new AddressBook(model.getAddressBook()), new UserPrefs());
        expectedModel.updatePerson(lastFood, editedFood);
    ...
    public void execute_noFieldSpecifiedUnfilteredList_success() {
        ...
        Food editedFood = model.getFilteredPersonList().get(INDEX_FIRST_PERSON.getZeroBased());
    ...
    public void execute_filteredList_success() throws Exception {
        ...
        Food foodInFilteredList = model.getFilteredPersonList().get(INDEX_FIRST_PERSON.getZeroBased());
        Food editedFood = new PersonBuilder(foodInFilteredList).withName(VALID_NAME_BOB).build();
    ...
    public void execute_duplicatePersonUnfilteredList_failure() {
        Food firstFood = model.getFilteredPersonList().get(INDEX_FIRST_PERSON.getZeroBased());
        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder(firstFood).build();
    ...
    public void execute_duplicatePersonFilteredList_failure() {
        ...
        Food foodInList = model.getAddressBook().getPersonList().get(INDEX_SECOND_PERSON.getZeroBased());
        EditCommand editCommand = prepareCommand(INDEX_FIRST_PERSON,
    ...
    public void executeUndoRedo_validIndexUnfilteredList_success() throws Exception {
        ...
        Food editedFood = new PersonBuilder().build();
        Food foodToEdit = model.getFilteredPersonList().get(INDEX_FIRST_PERSON.getZeroBased());
        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder(editedFood).build();
        EditCommand editCommand = prepareCommand(INDEX_FIRST_PERSON, descriptor);
        Model expectedModel = new ModelManager(new AddressBook(model.getAddressBook()), new UserPrefs());
        ...
        // undo -> reverts addressbook back to previous state and filtered food list to show all persons
        assertCommandSuccess(undoCommand, model, UndoCommand.MESSAGE_SUCCESS, expectedModel);

        // redo -> same first food edited again
        expectedModel.updatePerson(foodToEdit, editedFood);
    ...
    public void executeUndoRedo_validIndexFilteredList_samePersonEdited() throws Exception {
        ...
        expectedModel.updatePerson(foodToEdit, editedFood);
        assertNotEquals(model.getFilteredPersonList().get(INDEX_FIRST_PERSON.getZeroBased()), foodToEdit);
