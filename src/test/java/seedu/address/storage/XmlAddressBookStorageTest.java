...
public class XmlAddressBookStorageTest {
    ...
    @Test
    public void readAddressBook_invalidFoodAddressBook_throwDataConversionException() throws Exception {
        thrown.expect(DataConversionException.class);
        readAddressBook("invalidFoodAddressBook.xml");
    }

    @Test
    public void readAddressBook_invalidAndValidFoodAddressBook_throwDataConversionException() throws Exception {
        thrown.expect(DataConversionException.class);
        readAddressBook("invalidAndValidFoodAddressBook.xml");
    }
    ...
    public void readAndSaveAddressBook_allInOrder_success() throws Exception {
        ...
        original.addFood(HAM);
        original.removeFood(ALMOND);
        xmlAddressBookStorage.saveAddressBook(original, filePath);
        readBack = xmlAddressBookStorage.readAddressBook(filePath).get();
        assertEquals(original, new AddressBook(readBack));

        //Save and read without specifying file path
        original.addFood(ICECREAM);
